...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Bumper, function (sprite, otherSprite) {
    if (sprite.vy > 0 && !(sprite.isHittingTile(CollisionDirection.Bottom)) || sprite.y < otherSprite.top) {
        ...
        info.changeLifeBy(-1)
        sprite.say("Ouuu!!", invencibilidad)
...
function IniciarNivel (level: number) {
    ...
    ubicaciónInicial = tiles.getTilesByType(img`
        ...
        . . . . . . . . . . . . . . . . 
        `)[0]
    tiles.placeOnTile(mariobros64, ubicaciónInicial)
    tiles.setTileAt(ubicaciónInicial, assets.tile`transparency16`)
    Enemigos()
    Monedas()
}
function Salto () {
...
function AnimaciónMonedas () {
    animaciónMoneda = animation.createAnimation(ActionKind.Idle, 200)
    animaciónMoneda.addAnimationFrame(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . f f f f . . . . . . 
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Flier, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    sprite.say("Auu!!", invencibilidad * 1.5)
    music.powerDown.play()
    pause(invencibilidad * 1.5)
})
function Monedas () {
    for (let septimoValor of tiles.getTilesByType(assets.tile`tile5`)) {
        ...
        animation.attachAnimation(moneda, animaciónMoneda)
...
function AnimaciónSalto () {
    ...
    saltoDer = animation.createAnimation(ActionKind.JumpingRight, 100)
    animation.attachAnimation(mariobros64, saltoDer)
    saltoDer.addAnimationFrame(img`
        . . . . . . . f f . . . . . . . 
        . . . . . . f 2 2 f . . . . . . 
        . . . . . f 2 5 5 2 f . . . . . 
        . . . . f 2 2 1 1 2 2 f . . . . 
...
function Animaciones () {
    AnimaciónCorrer()
    AnimaciónPerfiIzquierdo()
    AnimaciónPerfiDerecho()
    AnimaciónGolpe()
    AnimaciónSalto()
}
...
function Enemigos () {
    for (let quintoValor of tiles.getTilesByType(assets.tile`tile4`)) {
        enemigo = sprites.create(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.Bumper)
        tiles.placeOnTile(enemigo, quintoValor)
        tiles.setTileAt(quintoValor, assets.tile`tile0`)
        enemigo.ay = gravedad
...
function AnimaciónGolpe () {
    golpePIzq = animation.createAnimation(ActionKind.CrouchLeft, 100)
    animation.attachAnimation(mariobros64, golpePIzq)
    golpePIzq.addAnimationFrame(img`
        . . . . . . . f f . . . . . . . 
        . . . . . . f 2 2 f . . . . . . 
        . . . . . f 2 5 5 2 f . . . . . 
        . . . . f 2 2 1 1 2 2 f . . . . 
        ...
        . . . . . . . . . . . . . . . . 
        `)
    golpePDer = animation.createAnimation(ActionKind.CrouchRight, 100)
    animation.attachAnimation(mariobros64, golpePDer)
    golpePDer.addAnimationFrame(img`
        . . . . . . . f f . . . . . . . 
        . . . . . . f 2 2 f . . . . . . 
        . . . . . f 2 5 5 2 f . . . . . 
        . . . . f 2 2 1 1 2 2 f . . . . 
...
game.onUpdate(function () {
    for (let octabaValor of sprites.allOfKind(SpriteKind.Flier)) {
        if (Math.abs(octabaValor.x - mariobros64.x) < 60) {
            if (octabaValor.x - mariobros64.x < -5) {
                octabaValor.vx = 25
            } else if (octabaValor.x - mariobros64.x > 5) {
                octabaValor.vx = -25
            }
            if (octabaValor.y - mariobros64.y < -5) {
                octabaValor.vy = 25
            } else if (octabaValor.y - mariobros64.y > 5) {
                octabaValor.vy = -25
            }
            animation.setAction(octabaValor, ActionKind.Flying)
        } else {
            octabaValor.vy = -20
            octabaValor.vx = 0
            animation.setAction(octabaValor, ActionKind.Idle)
        }
    }
})
game.onUpdate(function () {
